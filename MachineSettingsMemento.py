...
class MachineSettingsMemento(object):
    ...
    (M): comma seprated
    (C): colon seprated
    selected cipher rotors init order(S)|Thier init offset(S)|plugboard(SC) pairs|active swap signals(S)|selected L1 rotors Order(S)|Thier init Offset(S)|L1 L2 Mapper offset|selected L2 rotors order(S)|Their init offset(S)|L2 Cipher Mapper wiring pairs (CSM)

    Example:
    01 03 05 | 00 15 18 |0 1 , 2 3 |11 19 30 |02 03 |22 25 |55 |07 03 | 11 13 |0: 01 03 ,04: 03 02 04
    ...
    def restoreMachineSettings(self,machine):
        pass


    @classmethod
    def backupFromMachine(cls,mc):
        pass
        pass
